...
def detect_cars(video_file):
    ...
    config_path = os.path.join(script_dir, 'yolov4-tiny.cfg')
    ...
    # Set preferable backend and target (using CPU instead of CUDA)
    ...
    while True:
        ...
        # Display the frame (commented out for headless mode)
